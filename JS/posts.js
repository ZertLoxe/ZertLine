                            ...
                            for (let i = 0; i < post[postVarLink].postElements.length; i++) {
                                if (JSON.stringify(post[postVarLink].postElements[i].postElementStructure) !== JSON.stringify(["false", "0", "0"])) {
                                    ...
                                    if (post[postVarLink].postElements[i].postElementStructure[1] === "2") {
                                        for (let j = 0; j < post[postVarLink].postElements[i].media.length; j++) {
                                            if (post[postVarLink].postElements[i].media[j][0] === "I") {
                                                outMedia += "<img src='https://lh3.google.com/u/0/d/" + post[postVarLink].postElements[i].media[j][1] + "' id='post-element-image' class='media-item' loading='lazy'>";
                                            } else {
                                        ...
                                        if (post[postVarLink].postElements[i].media[0] === "I") {
                                            outMedia = "<img src='https://lh3.google.com/u/0/d/" + post[postVarLink].postElements[i].media[1] + "' id='post-element-image' class='media-item' loading='lazy'>";
                                        } else {
                                    ...
                                    if (post[postVarLink].postElements[i].elementShape === "RM") {
                                        ...
                                        outPostElements += "<div id='post-element-part-AG'>" + outTitle + "<div id='post-element-media-holder' class='AG-post-element-media-holder'><button class='AG-arrow-left-button' data-slider=" + AGDataSlider + " data-direction='left'><svg id='AG-arrow-left' class='AG-arrow-left' viewBox='0 0 650.34 1000'><path d='M618.4,926.79l-41.27,41.27c-42.58,42.58-111.62,42.58-154.2,0L31.93,577.06c-42.58-42.58-42.58-111.62,0-154.2L422.87,31.93c42.58-42.58,111.62-42.58,154.2,0l41.31,41.31c42.58,42.58,42.58,111.62,0,154.2l-234.01,234.01c-21.29,21.29-21.29,55.81,0,77.1l234.05,234.05c42.58,42.58,42.58,111.62,0,154.2Z'/></svg></button><div data-slider=" + AGDataSlider + " class='AG-post-element-media-holder-slider'>" + outMedia + "</div><button class='AG-arrow-right-button' data-slider=" + AGDataSlider + " data-direction='right'><svg id='AG-arrow-right' class='AG-arrow-right' viewBox='0 0 650.34 1000'><path d='M31.93,73.21L73.21,31.93c42.58-42.58,111.62-42.58,154.2,0l391,391c42.58,42.58,42.58,111.62,0,154.2L227.47,968.07c-42.58,42.58-111.62,42.58-154.2,0l-41.31-41.31c-42.58-42.58-42.58-111.62,0-154.2l234.01-234.01c21.29-21.29,21.29-55.81,0-77.1L31.93,227.4c-42.58-42.58-42.58-111.62,0-154.2Z'/></svg></button></div><div id='post-element-text-holder'>" + outText + "</div></div><hr>";
                                        AGDataSlider += 1
                                    } else {
